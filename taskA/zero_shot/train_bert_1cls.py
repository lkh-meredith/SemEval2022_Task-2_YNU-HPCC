...
if __name__=="__main__":
    model_path ='../model/bert-base-multilingual-cased'  #'../model/xlm-roberta-base'
    ...
    model_save_path=os.path.join('..', 'model', 'ZeroShot','bert_Linear_1cls')
    #两个编码器
    ...
    for epoch in range(num_epochs):
        ...
        results_file = os.path.join('..', 'submission', 'ZeroShot','bert_Linear_1cls','dev.combined_results-' + str(epoch+1) + '_' + str(train_batch_size) + '.csv')
        ...
        if best_dev_result < results[3][2]:#记录[EN,PT] F1 score最好的模型
            ...
            output_model_file = os.path.join(model_save_path,"mBERT-base_epoch_{}_batch_{}.pkl".format(best_epoch,train_batch_size))
    ...
    results_file = os.path.join('..', 'submission', 'ZeroShot','bert_Linear_1cls','test.combined_results-' + str(best_epoch) + '_' + str(train_batch_size) + '.csv')
    write_csv(submission_data, results_file)
